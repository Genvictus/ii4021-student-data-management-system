...
public class TranscriptController {
        ...
        public FormattedResponseEntity<List<TranscriptDto>> getTranscripts(
                ...
                List<TranscriptDto> transcripts = switch (userInfo.getRole()) {
                        case Role.STUDENT -> {
                                Transcript transcript = this.transcriptService
                                                .findTranscriptByStudentId(userInfo.getUserId()).get();
        ...
        public FormattedResponseEntity<TranscriptDto> createTranscript(
                ...
                return new FormattedResponseEntity<TranscriptDto>(HttpStatus.OK, true, "Transcript created",
                                createdTranscript);
        }
